...
public class CustomerProofOfIdService {
    ...
    public CustomerProofOfId updateCustomerProofOfId(Long id, CustomerProofOfId newCustomerProofOfId) {
        return customerProofOfIdRepository.findById(id).map(customerProofOfId -> {
            ...
            customerProofOfId.setCrudValue(newCustomerProofOfId.getCrudValue());
            customerProofOfId.setUserId(newCustomerProofOfId.getUserId());
            customerProofOfId.setWsId(newCustomerProofOfId.getWsId());
            customerProofOfId.setProgramId(newCustomerProofOfId.getProgramId());
            customerProofOfId.setAcceptTimestamp(newCustomerProofOfId.getAcceptTimestamp());
            customerProofOfId.setAcceptTimestampUtcOffset(newCustomerProofOfId.getAcceptTimestampUtcOffset());
            customerProofOfId.setUuid(newCustomerProofOfId.getUuid());
            return customerProofOfIdRepository.save(customerProofOfId);
