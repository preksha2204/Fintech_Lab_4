...
public class CustomerDetailsService {
	...
	public CustomerDetails updateCustomerDetails(Long id, CustomerDetails newCustomerDetails) {
		return customerDetailsRepository.findById(id).map(customerDetails -> {
			...
			customerDetails.setCrudValue(newCustomerDetails.getCrudValue());
	        customerDetails.setUserId(newCustomerDetails.getUserId());
	        customerDetails.setWsId(newCustomerDetails.getWsId());
	        customerDetails.setProgramId(newCustomerDetails.getProgramId());
	        customerDetails.setAcceptTimestamp(newCustomerDetails.getAcceptTimestamp());
	        customerDetails.setAcceptTimestampUtcOffset(newCustomerDetails.getAcceptTimestampUtcOffset());
	        customerDetails.setUuid(newCustomerDetails.getUuid());
