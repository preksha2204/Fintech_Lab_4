...
public class CustomerIdentificationService {
	...
	public CustomerIdentification updateCustomerIdentification(Long id, CustomerIdentification newCustomerIdentification) {
	    return customerIdentificationRepository.findById(id).map(customerIdentification -> {
	        ...
	        customerIdentification.setCrudValue(newCustomerIdentification.getCrudValue());
	        customerIdentification.setUserId(newCustomerIdentification.getUserId());
	        customerIdentification.setWsId(newCustomerIdentification.getWsId());
	        customerIdentification.setProgramId(newCustomerIdentification.getProgramId());
	        customerIdentification.setAcceptTimestamp(newCustomerIdentification.getAcceptTimestamp());
	        customerIdentification.setAcceptTimestampUtcOffset(newCustomerIdentification.getAcceptTimestampUtcOffset());
	        customerIdentification.setUuid(newCustomerIdentification.getUuid());
